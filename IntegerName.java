...
public class IntegerName
{
   ...
   */
   public static String intName(int number)
   {
      ...
      if (part >= 1000000)// 1,000,000
      {
         name = digitName(part / 1000000)  + " million " + tensName(part / 100000) + digitName(part / 1000000);
         part = part % 100000;
         return name + intName(part);
      }

      if (part >= 100000)// 100,000
      {
   ...
   /**
    * 
    * @param digit a negative integer
    * @return a "negative" if the digit number is lower than 0 or has a negative sign in front.
    */
   public static String negativeNum(int number)
   {
